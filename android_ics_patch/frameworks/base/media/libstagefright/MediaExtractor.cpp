...
sp<MediaExtractor> MediaExtractor::Create(
    ...
    if( source->ff_ptr ){
        ...
        if (libHandle == NULL) { LOGE("unable to dlopen libpeony_demuxer.so"); return false; }
        ...
        if (ext_func == NULL) { LOGE("unable to dlsym ext_func"); dlclose(libHandle); libHandle = NULL; return false; }
        ret = (*ext_func)(source);
    } else 
#endif
